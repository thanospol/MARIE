function varargout = MARIE_PlotSlice(varargin)
...
%
%      MARIE_PLOTSLICE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MARIE_PLOTSLICE.M with the given input arguments.
%
%      MARIE_PLOTSLICE('Property','Value',...) creates a new MARIE_PLOTSLICE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MARIE_PlotSlice_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MARIE_PlotSlice_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MARIE_PlotSlice

% Last Modified by GUIDE v2.5 25-Jun-2014 19:45:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MARIE_PlotSlice_OpeningFcn, ...
                   'gui_OutputFcn',  @MARIE_PlotSlice_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MARIE_PlotSlice is made visible.
function MARIE_PlotSlice_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MARIE_PlotSlice (see VARARGIN)

% Choose default command line output for MARIE_PlotSlice
...
% UIWAIT makes MARIE_PlotSlice wait for user response (see UIRESUME)
...
function varargout = MARIE_PlotSlice_OutputFcn(hObject, eventdata, handles) 
