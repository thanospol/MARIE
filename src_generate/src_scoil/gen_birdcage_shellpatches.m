...
fclose all;
clc;
geofilename = ('Birdcage_conformal_140mm.geo');

Res = 0.025;

Nleg = 16; % number of legs
Rad = 0.140; % radius
Len = 0.200; % external length
Wid = 0.010; % width
Gap = 0.005; % gap
Ztrans = 0; % position in the Z direction
Arot = 0*pi/180; % rotation of the coil
