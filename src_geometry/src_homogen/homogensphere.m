function [idx,epsilon_r,sigma_e,rho,mu_r,sigma_m] = homogensphere(r,Cnt,Rad,e_r,s_e,dens,m_r,s_m)
%%    Defines a Sphere, and assigns homogeneous properties
% _________________________________________________________________________
%
%       Defines a Sphere in a given domain.
%       Optionally assigns material properties to the sphere
%
% _________________________________________________________________________
%
%% INPUT
