function [Zbc] = Assembly_SCOUP_QMEX(Scoord,index,etod,node,elem,freq,LEVEL_DVrule) 
%%    Quadrature coupling for the SIE+VIE solver (Mexed)
% _________________________________________________________________________
%
%   Fucntion to generate the Quadrature-based Coupling SIE to VIE
%   Applies a mex function to compute all elements
%
% _________________________________________________________________________
%
%% Input
